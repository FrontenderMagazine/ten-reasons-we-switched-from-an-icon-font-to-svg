...
иконки были упакованы в один с ним файл, при чём глифы хранились в области 
...
Отделение важных иконок от второстепенных шрифта и остальных иконок дало нам 
...
Chrome Canary и Beta недавно поразила довольно отвратительная [ошибка при 
...
действует на нервы. Обычно от этого страница не становится неудобной в 
использовании. А вот когда тот самый шрифт отвечает и за отображение иконок, 
страница внезапно заполняется мусором из чёрных квадратиков, в результате чего 
выглядит плохо. 

Эта ошибка появилась как раз когда мы осуществляли переход на SVG. Мы вздохнули 
с облегчением перейдя на новую систему отображения иконок когда только начали 
приходить первые отчёты об обнаружении этой ошибки на нашем сайте.
...
Используя SVG нам было легче разобраться с размещением. Мы используем 
...
Вставка иконок через иконочный шрифт всё же имеет некоторые преимущества над SVG 
...
роскошь, которая очень способствует быстроте разработки. Она также стала 
причиной нашего длительного воздержания от перехода на SVG.
...
На Grunticon каждая иконка объявляется отдельно, таким образом избегается 
использование спрайтов. Мы последовали примеру с этим подходом, но, хотя мы и 
...
Иконочный шрифт [работает во всех браузерах вплоть до IE8][9], в отличии от 
...
вам нужно изменить размер больше чем для одного-двух изображений. Мы обнаружили 
